...
// use can use useparams or u use match.params.id
// console.log(id)
...
// the input tupe is a number field called type="number"
//remember by default the value is 1 so if the value which is 1 is greater or equals 
//to our product.stock we return  1.
...
function setUserRatings () {
    ...
    //index is the current number or position of sth
    //click event
    stars.forEach((star, index) => {
        star.starValue = index + 1;  // put ; to show d statement ends der
        ...
        <MetaData title={product.name} />
           <Carousel pause="hover" >
               {product.images && product.images.map(image => {
                 return  (<Carousel.Item key= {image.public_id}>
